...
%------ SPECIFY DATA ------------------------------------------------------
PATH= pwd; % path, where data are saved
HEADERFILE= 's20061.hea.txt';      % header-file in text format
ATRFILE= 's20061.atr';         % attributes-file in binary format
DATAFILE='s20061.dat';         % data-file
